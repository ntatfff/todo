...
tasks = [
    {
        ...
        "output": "./output/10p/kernel5/XGBoost.all.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.firstorder.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.glcm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.gldm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.glrlm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.glszm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/10p/kernel5/XGBoost.ngtdm.ipynb",
        "params": {
