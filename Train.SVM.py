...
tasks = [
    {
        ...
        "output": "./output/10p/kernel3/SVM.all.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.firstorder.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.glcm.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.gldm.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.glrlm.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.glszm.ipynb",
        "params": {
    ...
    {
        "input": "Train.SVM.ipynb",
        "output": "./output/10p/kernel3/SVM.ngtdm.ipynb",
        "params": {
