...
tasks = [
    {
        ...
        "output": "./output/mask5/10p/kernel3/RandomForest.all.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.firstorder.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.glcm.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.gldm.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.glrlm.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.glszm.ipynb",
        "params": {
    ...
    {
        "input": "Train.RandomForest.ipynb",
        "output": "./output/mask5/10p/kernel3/RandomForest.ngtdm.ipynb",
        "params": {
