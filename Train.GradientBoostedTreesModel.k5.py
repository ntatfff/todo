...
tasks = [
    {
        ...
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.all.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.firstorder.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.glcm.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.gldm.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.glrlm.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.glszm.ipynb",
        "params": {
    ...
    {
        "input": "Train.GradientBoostedTreesModel.ipynb",
        "output": "./output/10p/kernel5/GradientBoostedTreesModel.ngtdm.ipynb",
        "params": {
