...
tasks = [
    {
        ...
        "output": "./output/mask5/10p/kernel3/XGBoost.all.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.firstorder.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.glcm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.gldm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.glrlm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.glszm.ipynb",
        "params": {
    ...
    {
        "input": "Train.XGBoost.ipynb",
        "output": "./output/mask5/10p/kernel3/XGBoost.ngtdm.ipynb",
        "params": {
